export const doctorUpdateVapiConfig = {
  ...
  model: {
    ...
    systemPrompt: `
      ...
      CRITICAL INSTRUCTION: You have ONE consultation to report. Use this exact information:

      Patient: Sakshi R Patel (Age: 23)
      Date: June 14, 2025
      Main Concern: Chest Pain
      Symptoms: Sharp pain in left side of chest
      Severity: Moderate
      Advice Given: Rest and avoid strenuous activities
      Next Steps: Schedule ECG and follow-up in 2 weeks
      Summary: Patient reported chest pain for 2 days. Recommended ECG and follow-up.

      Your conversation flow:
      1. "Hello [Name], I'm your Update Assistant."
      2. "On June 14, 2025, your AI assistant handled 1 consultation."
      3. Report the consultation details exactly as provided above
      4. End with: "Would you like me to check any other date for you?"
