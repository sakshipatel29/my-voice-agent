  ...
  return (
    <main className="min-h-screen bg-gray-50 mt-4">
      <div className="relative">
        ...
        <h1 className="relative text-3xl font-black text-center mb-8 tracking-wider uppercase animate-fade-in">
      ...
      {/* Footer Section */}
      <footer className="bg-gray-300 text-white mt-16">
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {/* Hospital Info */}
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-blue-400">Sunrise Medical Hospital</h3>
              <p className="text-gray-400">Providing quality healthcare services since 1995. Your health is our priority.</p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Find a Doctor</a></li>
                <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">Patient Portal</a></li>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} Sunrise Medical Hospital. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </main>
